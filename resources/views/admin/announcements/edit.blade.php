...
<div class="card mb-4 p-4">
    <h6 class="mb-0 text-uppercase fw-bold">Edit Announcement</h6>
</div>
        ...
        <form action="{{ route('announcements.update', $announcement) }}" method="POST">
                ...
                <div class="col-md-8">
                    <div class="mb-3">
                        ...
                        <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror"
                            placeholder="Enter announcement title" value="{{ old('title', $announcement->title) }}" required>
                        @error('title')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror"
                            rows="6" placeholder="Enter announcement details..." required>{{ old('description', $announcement->description) }}</textarea>
                        @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" id="category" name="category" class="form-control @error('category') is-invalid @enderror"
                            placeholder="e.g., academic, event, general" value="{{ old('category', $announcement->category) }}">
                    ...
                    <div class="alert alert-info small">
                        <strong>Last updated:</strong> {{ is_string($announcement->updated_at) ? \Carbon\Carbon::parse($announcement->updated_at)->format('M d, Y \a\t H:i') : $announcement->updated_at->format('M d, Y \a\t H:i') }}
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <i data-lucide="save" style="width: 14px;" class="me-1"></i>Update Announcement
                </button>
