...
<div class="card mb-4 p-4">
    <div class="d-flex align-items-center justify-content-between">
        <h6 class="mb-0 text-uppercase fw-bold">Create New Role</h6>
        <div>
                ...
                <form action="{{ route('admin.access-control.roles.store') }}" method="POST">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i data-lucide="save" style="width: 14px;" class="me-1"></i>Create Role
                        </button>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-sm text-muted">
                    <strong>Role:</strong> A role is a collection of permissions that can be assigned to users.
                </p>
                <p class="text-sm text-muted">
                    <strong>Permission:</strong> Define specific actions users can perform in the system.
                </p>
                <hr>
